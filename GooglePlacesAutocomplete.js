...
export default class GooglePlacesAutocomplete extends Component {
    ...
    return (
      <Text
        style={[
          ...
          this.props.customStyles.description,
          rowData.isPredefinedPlace
            ? this.props.customStyles.predefinedPlacesDescription
            : {}
        ]}
        numberOfLines={1}
      >
  ...
  _renderRow = (rowData = {}, sectionID, rowID) => {
    return (
      <ScrollView
        style={[{ flex: 1 }, this.props.customStyles.scrollView]}
        ...
        >
          <View
            style={[
              ...
              rowData.isPredefinedPlace
                ? this.props.customStyles.specialItemRow
                : {}
            ]}
          >
    ...
    return (
      <View
        style={[
          ...
          this.props.customStyles.poweredContainer
        ]}
      >
        <Image
        ...
        {!this.props.textInputHide && (
          <View
            style={[
              ...
              this.props.customStyles.textInputContainer
            ]}
          >
            ...
            <TextInput
              ...
              style={[
                ...
                this.props.customStyles.textInput
              ]}
